        ...
        {isEditing ? (
          <div>
            ...
            <div className='d-flex flex-row justify-content-between mb-3'>
              <h1 className='animate__animated text-coral animate__fadeIn ps-3 aria-controls="navbar"'><span className='d-lg-block d-none'>Profile</span></h1>
              <div className='d-flex'>
                <div className='me-3'>
                  <button onClick={handleSaveClick} className=' submit '>Save</button>
                </div>

                <div>
                  <button onClick={handleCancelClick} className=' submit'>Cancel</button>
                </div>
          ...
          <div>
            <div className='d-flex flex-row justify-content-between mb-3 px-3'>
              <h1 className='animate__animated text-coral animate__fadeIn'><span className='d-lg-block d-none'>Profile</span></h1>
              <div>
                <button onClick={handleEditClick} className='animate__animated animate__fadeIn submit aria-expanded="false" data-bs-target="#navbar" aria-controls="navbar"'>Edit</button>
              </div>
            </div>
